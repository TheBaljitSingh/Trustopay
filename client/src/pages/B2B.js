    ...
    <Header/>
      <div className=' h-screen max-w-full flex flex-col md:flex-row pl-16 justify-center items-center'>
        ...
        <div className="w-full md:w-1/2  flex justify-end items-center ">
          ...
          <div className=' flex justify-end   animate-fade-left'>
          <img className=' w-[400px] h-[500px] items-center object-cover rounded-xl' src='https://cdn.prod.website-files.com/6598f4892384e3889d845a2d/666011ab77d2a3adf8a24a12_img_saas_solution1-p-800.webp' alt="" />
