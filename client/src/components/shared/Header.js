...
function Header() {
  ...
  return (
    <header className={showHeader ? "bg-white text-white sticky left-0 top-0 z-50 w-full py-4 transition duration-100 shadow-sm" : "bg-white shadow-md text-white sticky left-0 top-0 z-50 w-full py-4 transition duration-100"}>
      <nav className="container mx-auto flex justify-between px-2 md:px-14">
        <div className="text-2xl font-bold text-black">
          <Link to="/"> <img className='mt-5' src='https://trustopay.vercel.app/assets/images/trustopay_logo_m%201.png' alt="Logo" /></Link>
        </div>
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
      ...
      <li>
        ...
        <div className="flex space-x-4">
          <button className="border border-indigo-600 text-indigo-600 hover:bg-indigo-600 hover:text-white py-2 px-4 rounded">
            Notify me
          </button>
